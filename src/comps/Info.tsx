      ...
      <div className="w-[2000px] max-h-[3172px] bg-white rounded-[72px] p-[48px]">
        ...
        <div className="mt-[24px] grid grid-cols-2 gap-[16px]">
          ...
          <div className="w-[944px] h-[250px] text-center rounded-[48px] bg-[#04341C0D] p-[48px]">
            ...
            <div
              id="hoursHandler"
              className="text-[48px] text-text font-normal leading-[100%] mt-[16px]"
            />
          </div>
          <div className="w-[944px] h-[250px] text-center rounded-[48px] bg-[#04341C0D] p-[48px]">
            <div className="text-[42px] text-text font-bold leading-[100%]">
        ...
        {pointData.description && (
          <div id="infoHandler" className="mt-[24px] text-text text-[40px]" />
        )}
        <div className="mt-[48px] flex justify-center gap-[16px]">
          <button 
            onClick={onTrace}
            className="w-[944px] h-[144px] rounded-[48px] bg-light-green text-white flex justify-center items-center text-[48px] font-semibold leading-[100%]">
            Построить маршрут
          </button>
          <button
            onClick={() => {
